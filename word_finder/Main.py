...
def getresults():
    ...
    print(f'results for {Word} are: \n Def:{Results[0]["meanings"][0]["definitions"][0]["definition"]} \n part of speech: {Results[0]["meanings"][0]["partOfSpeech"]} \n synonyms:{syn}\n antonyms:{ant} \n pronounce:{pro} \n world history:{worldhistory} \n firstused: {firstused}')
    amount = int(input(f"{len(example)} examples found how many would you like to see?"))
